  ...
  GooglePlayServicesClient.OnConnectionFailedListener
    ...
    public int onStartCommand (Intent intent, int flags, int startId)
    {
        ...
        if(!servicesAvailable || mLocationClient.isConnected() || mInProgress){
        	Log.d("Raymond", "!servicesAvailable");
        	return START_STICKY;
        }
...
//        appendLog(DateFormat.getDateTimeInstance().format(new Date()) + ": Connected", GeofenceUtils.LOG_FILE);
        Log.d("Raymond", "Connected");
    }
...
//        appendLog(DateFormat.getDateTimeInstance().format(new Date()) + ": Disconnected", GeofenceUtils.LOG_FILE);
        Log.d("Raymond", "Disconnected");
    }
